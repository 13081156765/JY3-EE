...
public class Product {
    ...
    public Product(String pro_id, String pro_name, Double pro_price, String pro_image, String pro_des, Integer pro_stock, Date pro_date, Integer pro_category_id, String pro_factory) {
        this.pro_id = pro_id;
